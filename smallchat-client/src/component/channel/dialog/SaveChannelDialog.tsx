  ...
  render() {
    ...
    return (
      <Modal show={this.props.show} size="lg" onHide={this.handleCancel}>
        <Formik validationSchema={schema} onSubmit={this.handleSubmit} initialValues={valueChannel}>
              ...
              <Modal.Body>
                <Form.Group className="required" controlId="formId">
                  ...
                  <Form.Control
                    ...
                    required
                    pattern={ChannelModel.ID_PATTERN}
                    value={values.id}
                  ...
                  />
                  <Form.Text className="text-muted">You can't change the id after the creation.</Form.Text>
